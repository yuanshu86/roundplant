...
class Plant {
  ...
  /// 距下次修剪天数（<=0 表示该修剪了）
  int get daysUntilPruning =>
      nextPruning.difference(DateTime.now()).inDays;
...
class CareTask {
  ...
  static List<CareTask> fromPlants(List<Plant> plants) {
    final today = DateTime.now();
    return plants.where((p) => p.daysUntilWatering <= 0).map((p) => CareTask(
      id: 'task_${p.id}',
      plantId: p.id,
      plantName: p.name,
      taskType: 'watering',
...
class NearbyUser {
  ...
  static List<NearbyUser> sampleUsers = [
    NearbyUser(
      id: 'u1', name: '小绿', avatarColor: 0xFF059669, plantIcon: 'leaf',
      distance: 280, tag: '多肉爱好者',
      plants: [
        FriendPlant(name: '桃蛋', scientificName: 'Graptopetalum amethystinum', healthStatus: '健康', careDays: 89, lightReq: '充足阳光'),
        FriendPlant(name: '熊童子', scientificName: 'Cotyledon tomentosa', healthStatus: '健康', careDays: 67, lightReq: '充足阳光'),
        FriendPlant(name: '生石花', scientificName: 'Lithops', healthStatus: '需关注', careDays: 45, lightReq: '充足阳光'),
      ],
    ),
    NearbyUser(
      id: 'u2', name: '花间', avatarColor: 0xFFD97706, plantIcon: 'flower',
      distance: 520, tag: '蕨类专精',
      plants: [
        FriendPlant(name: '波士顿蕨', scientificName: 'Nephrolepis exaltata', healthStatus: '健康', careDays: 120, lightReq: '明亮散射光'),
        FriendPlant(name: '铁线蕨', scientificName: 'Adiantum capillus-veneris', healthStatus: '健康', careDays: 95, lightReq: '半阴环境'),
      ],
    ),
    NearbyUser(
      id: 'u3', name: '新芽', avatarColor: 0xFF0D9488, plantIcon: 'sprout',
      distance: 850, tag: '苔藓玩家',
      plants: [
        FriendPlant(name: '白发藓', scientificName: 'Leucobryum glaucum', healthStatus: '健康', careDays: 156, lightReq: '弱光耐受'),
        FriendPlant(name: '大灰藓', scientificName: 'Hypnum plumaeforme', healthStatus: '健康', careDays: 112, lightReq: '弱光耐受'),
        FriendPlant(name: '万年藓', scientificName: 'Climacium dendroides', healthStatus: '需关注', careDays: 78, lightReq: '半阴环境'),
      ],
    ),
    NearbyUser(
      id: 'u4', name: '绿手指', avatarColor: 0xFF7C3AED, plantIcon: 'seedling',
      distance: 1200, tag: '香草达人',
      plants: [
        FriendPlant(name: '迷迭香', scientificName: 'Rosmarinus officinalis', healthStatus: '健康', careDays: 201, lightReq: '充足阳光'),
        FriendPlant(name: '薄荷', scientificName: 'Mentha', healthStatus: '健康', careDays: 188, lightReq: '明亮散射光'),
      ],
    ),
    NearbyUser(
      id: 'u5', name: '窗台有风', avatarColor: 0xFFDC2626, plantIcon: 'rose',
      distance: 1800, tag: '阳台花园',
      plants: [
        FriendPlant(name: '月季', scientificName: 'Rosa chinensis', healthStatus: '健康', careDays: 310, lightReq: '充足阳光'),
        FriendPlant(name: '绣球', scientificName: 'Hydrangea macrophylla', healthStatus: '健康', careDays: 245, lightReq: '半阴环境'),
        FriendPlant(name: '茉莉', scientificName: 'Jasminum sambac', healthStatus: '需关注', careDays: 178, lightReq: '充足阳光'),
      ],
    ),
  ];
}
